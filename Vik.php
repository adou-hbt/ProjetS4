...
<section class="activites">
    ...
    <table class="tableau-activites">
        ...
        <tr>
            ...
            <td>150€</td>
            <td><input type="checkbox" name="activites[]" value="Visitez le village de Vik" class="activite-checkbox"></td>
        </tr>
        <tr>
            ...
            <td>200€</td>
            <td><input type="checkbox"  name="activites[]" value="Parcours de Golf" class="activite-checkbox"></td>
        </tr>
        <tr>
            ...
            <td>250€</td>
            <td><input type="checkbox"  name="activites[]" value="Visitez les plages de sable noirs"  class="activite-checkbox"></td>
        </tr>
