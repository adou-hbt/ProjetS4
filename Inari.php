...
<section class="activites">
  ...
  <table class="tableau-activites">
    ...
    <tr>
      ...
      <td>Parc abritant les plus beaux rennes de Finlande.</td>
      <td><img src="photos%20du%20site/renneparc.jpg" alt="Village du Père Noël" class="img-activite"></td>
      <td>180€</td>
      <td><input type="checkbox" name="activites[]" value="Visite du parc de rennes" class="activite-checkbox"></td>
    </tr>
    <tr>
      ...
      <td>140€</td>
      <td><input type="checkbox" name="activites[]" value="Randonnée en raquettes" class="activite-checkbox"></td>
    </tr>
