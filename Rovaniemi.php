...
<section class="activites">
  ...
  <table class="tableau-activites">
    ...
    <tr>
      ...
      <td>200€</td>
      <td><input type="checkbox" name="activites[]" value="Safari en motoneige" class="activite-checkbox"></td>
    </tr>
    <tr>
      <td>Observation des aurores boréales</td>
      <td>Profitez d'un spectacle naturel fascinant dans le ciel finlandais.</td>
      <td><img src="photos%20du%20site/boréale.png" alt="Observation des aurores boréales" class="img-activite"></td>
      <td>250€</td>
    ...
    <tr>
      ...
      <td>180€</td>
      <td><input type="checkbox" name="activites[]" value="Visite du village du Père Noël" class="activite-checkbox"></td>
    </tr>
