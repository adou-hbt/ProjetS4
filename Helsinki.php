...
<section class="activites">
  ...
  <table class="tableau-activites">
    ...
    <tbody>
    <tr>
      <td>Visitez la capital</td>
      <td>Venez visité la capital Helsinki</td>
      <td><img src="photos%20du%20site/Helsinki2.jpg" alt="Motoneige" class="img-activite"></td>
      <td>200€</td>
      <td><input type="checkbox" name="activites[]" value="Visitez la capital" class="activite-checkbox"></td>
    </tr>
    <tr>
      <td>Vivez la nuit dans la capital</td>
      <td>Venez vous amusez dans les meilleurs boîtes d'Helsinki</td>
      <td><img src="photos%20du%20site/boiteHelsinki.jpg" alt="Aurores boréales" class="img-activite"></td>
      <td>250€</td>
      <td><input type="checkbox" name="activites[]" value="Vivez la nuit dans la capital" class="activite-checkbox"></td>
    </tr>


    <tr>
      <td>Profiter des Spas</td>
      <td>Le Kämp Wellness est un SPA qui vous permettra de vous détendre et de vous revigorer.</td>
      <td><img src="photos%20du%20site/Kämp Wellness.jpeg" alt="Sauna finlandais" class="img-activite"></td>
      <td>160€</td>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $activites = [
        'Visitez la capital' => 200,
        'Vivez la nuit dans la capital' => 250,
