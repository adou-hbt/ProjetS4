...
<section class="activites">
    ...
    <table class="tableau-activites">
        ...
        <tr>
            ...
            <td>180€</td>
            <td><input type="checkbox" name="activites[]" value="Découverte du soleil de minuit" class="activite-checkbox"></td>
        </tr>
        <tr>
            ...
            <td>220€</td>
            <td><input type="checkbox" name="activites[]" value="Découverte des aurores" class="activite-checkbox"></td>
        </tr>
        <tr>
            ...
            <td>170€</td>
            <td><input type="checkbox" name="activites[]" value="Randonnée dans les Alpes de Lyngen" class="activite-checkbox"></td>
        </tr>
        </tbody>
    </table>
